        ...
        <div className="mt-12">
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              <h3 className="text-lg leading-6 font-bold text-JonesCo-Blue-900">About Colored Gutters</h3>
                ...
                <div className="bg-JonesCo-Blue-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-JonesCo-Blue-900 sm:mt-0 sm:col-span-2">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <img src="/images/colored-gutter-1.jpg" alt="Colored gutter example" className="w-full h-full object-cover rounded-lg shadow-md"/>
                      <img src="/images/colored-gutter-2.jpg" alt="Colored gutter example" className="w-full h-full object-cover rounded-lg shadow-md"/>
                    </div>
                  </dd>
                </div>
              </dl>
