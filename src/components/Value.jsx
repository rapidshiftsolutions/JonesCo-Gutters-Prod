...
export default function ValueProps() {
  ...
  return (
    <div className="sm:bg-gradient-to-b bg-gradient-to-r from-JonesCo-Lighting-Red-100 to-JonesCo-Lighting-Red-200">
    <div className=" container mx-auto py-12 px-4">
    <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-base font-semibold leading-7 text-JonesCo-Lighting-Red-600">Why Use JonesCo Lighting?</h2>
          <p className="mt-2 mb-6 text-2xl font-black tracking-tight text-JonesCo-Lighting-Red-950 sm:text-4xl">It&apos;s done right, the first time.</p>
        </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {valueProps.map((prop, index) => (
          ...
          >
            <div className="text-4xl mb-4 text-JonesCo-Lighting-Red-500">{prop.icon}</div>
