...
export default function CallToActionBlue() { 
  return (
    <div className="bg-white py-12 px-4">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl font-bold mb-4 text-gray-900">
          Worry-Free Lighting Solutions
        </h2>
        <p className="text-lg text-gray-600 mb-8">
          We handle everything from installation to cleanup, so you can relax.
        </p>

        {/* Blue Gradient Button with Pulse Animation */}
        <a
          href="/contact"
          target="_blank"
