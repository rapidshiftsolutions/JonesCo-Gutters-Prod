...
const benefits = [
  { id: 1, icon: CheckCircleIcon, title: 'Prevent Water Damage', description: 'Replacing old or damaged gutters prevents water damage to your home. Learn more about our Gutter Replacement Services.', link: '/gutter-replacement' },
  ...
  { id: 3, icon: CheckCircleIcon, title: 'Prevent Structural Damage', description: 'Proper gutter replacement protects your home’s foundation and structure. Check out our Seamless Gutter Installation.', link: '/seamless-gutter-installation' },
  { id: 4, icon: CheckCircleIcon, title: 'Reduce Maintenance', description: 'High-quality replacement gutters reduce the need for frequent maintenance. Explore our Gutter Guard Installation.', link: '/gutter-guards' },
  ...
  { id: 6, icon: CheckCircleIcon, title: 'Long-Term Durability', description: 'Our replacement gutters are designed to last, providing long-term durability and peace of mind. Book a free estimate today.', link: '/contact' },
];

function GutterReplacement() {
  return (
    <div>
      ...
      <div className="bg-JonesCo-Blue-900 text-white py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Why Replace Your Gutters?</h2>
            <p className="mt-4 text-base sm:text-lg md:text-xl leading-8">Proper gutter replacement is essential for protecting and enhancing your home. Here’s why it matters:</p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black leading-tight text-JonesCo-Green-100">
              JonesCo Gutter Replacement in 4 Steps
            </h2>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 text-center">
            <div className="bg-JonesCo-Green-950 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                We start with a thorough assessment of your current gutter system to identify any issues and determine the best replacement options.<br></br> <Link href="/contact" legacyBehavior><a className="underline text-JonesCo-Green-300">Contact Us</a></Link>
              </p>
            </div>
            <div className="bg-JonesCo-Green-950 p-6 rounded-lg shadow-lg">
