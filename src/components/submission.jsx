...
export default function EstimateConfirmation() {
  return (
    <div className="bg-JonesCo-Lighting-Green-100 py-24 px-6 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        <CheckCircleIcon className="mx-auto h-16 w-16 text-JonesCo-Lighting-Green-500 mb-6" />
