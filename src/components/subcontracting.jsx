      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-JonesCo-Blue-800 mb-2">Expertise & Experience</h3>
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-JonesCo-Blue-800 mb-2">Quality & Durability</h3>
            <p className="text-black">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-JonesCo-Blue-800 mb-2">Efficient & Reliable</h3>
            <p className="text-black">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-JonesCo-Blue-800 mb-2">Comprehensive Services</h3>
            <p className="text-black">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-JonesCo-Blue-800 mb-2">Customer Satisfaction</h3>
            <p className="text-black">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-JonesCo-Blue-800 mb-2">Community Focus</h3>
            <p className="text-black">
