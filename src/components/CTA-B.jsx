  ...
  return (
    <div className="bg-JonesCo-Green-100">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-32 lg:flex lg:items-center lg:justify-between lg:px-8">
        <h2 className="">
          <span className="text-xl tracking-tight text-JonesCo-Green-900 sm:text-3xl">Tired of Losing?</span>
          <br />
          <span className="text-5xl font-jc tracking-tight text-JonesCo-Green-900 sm:text-8xl">We Can Fix That.</span>
        </h2>
