...
export default function Home() {
  return (
    <>
      <Head>
        <title>JonesCo Seamless Gutter Systems || Custom Gutter Solutions</title>
        ...
        />
        <meta name="keywords" content="Custom Gutter Solutions, Seamless Gutter Installation, Gutter Replacement, Gutter Cleaning, Gutter Guards Installation, Downspout Installation, Eastern Tennessee, Newport, Dandridge, Morristown, Greeneville, Sevierville, Johnson City, Knoxville, Maryville" />
        <meta name="author" content="JonesCo Seamless Gutter Systems" />
        <meta property="og:title" content="JonesCo Seamless Gutter Systems || Custom Gutter Solutions" />
